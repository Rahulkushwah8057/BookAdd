  ...
  return (
    <div >
      ...
      <div className='table'>
                ...
                <td>
                  <input                 
                    ...
                    onChange={(e) => {
                      ...
                      //for updateing total price of book
                      const newTotal = newPrice * book.qty;
                      //for updateing the book object in the books array
        ...
        <p className="totalPrice">Grand Total: {books.reduce((acc, curr) => acc + curr.total, 0)}</p>
      </div>
      </div>);
}
